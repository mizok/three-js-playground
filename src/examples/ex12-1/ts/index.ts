import { AxesHelper, Clock, CylinderGeometry, Mesh, MeshStandardMaterial, PerspectiveCamera, PlaneGeometry, PointLight, Scene, WebGLRenderer } from 'three';
...
function main() {
  ...
  const cylinderMesh = new Mesh(
    new CylinderGeometry(10,10,20,50,50),
  ...
  pLight.position.set(12,12,12)
  pLight.castShadow = true;
  
  scene.add(planeMesh,cylinderMesh,pLight);
